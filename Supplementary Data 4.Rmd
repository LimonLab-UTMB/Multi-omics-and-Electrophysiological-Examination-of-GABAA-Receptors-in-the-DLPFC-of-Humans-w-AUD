---
title: "Proteomic Expression Analysis of Ionotropic Receptor Subunits, Trafficking, and Scaffolding Proteins in the Human Brain - 2025 Version"
...
Import dataset:
```{r}
d1 <- read_excel("./Prot GABAAR Subunits 1.xlsx")
d2 <- read_excel("./Prot GABAAR Subunits 2.xlsx")
...
fontsize = 5,
main = "Protein Expression Heatmap for AUD and control subjects"  # Title for the heatmap
)
```
